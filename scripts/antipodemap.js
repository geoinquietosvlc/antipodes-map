    ...
    layers: [
      new ol.layer.Tile({
        source: new ol.source.TileJSON({
          url: 'https://api.tiles.mapbox.com/v3/vehrka.k03kl0gg.jsonp',
    ...
    function(response){
      ...
      map.addLayer(new ol.layer.Tile({
          source: new ol.source.XYZ({
            ...
            urls: ['a','b','c','d'].map(function(s){
              return 'https://cartocdn-gusc-' + s + '.global.ssl.fastly.net/vehrka/api/v1/map/' + response.layergroupid + '/{z}/{x}/{y}.png' 
            }) 
          })
        }));
    }, function(error){
